...
export const DiscoveryView: React.FC<DiscoveryViewProps> = ({
  ...
  return (
    <div className="relative h-[calc(100dvh-5rem)] overflow-hidden bg-slate-50 dark:bg-[#0A0C12] flex">
      {/* ===== Desktop: filters in the left sidebar ===== */}
      <aside className="hidden lg:flex flex-col w-[300px] xl:w-[320px] flex-none border-r border-slate-200 dark:border-white/10 bg-white/70 dark:bg-[#0A0C12]/80 backdrop-blur-sm">
        <div className="flex-none px-5 pt-5 pb-3 border-b border-slate-100 dark:border-white/10">
          <p className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-[0.25em] text-indigo-600 dark:text-indigo-400">
        ...
        {drawerOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-y-0 left-0 w-[88%] max-w-sm bg-white dark:bg-white/[0.03] shadow-2xl flex flex-col"
            >
              <div className="flex-none flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-white/10">
                <p className="flex items-center gap-2 text-sm font-black text-slate-900 dark:text-slate-50">
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-slate-100 dark:bg-white/[0.05] hover:bg-slate-200 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 transition-colors"
      ...
      <main className="flex-1 min-w-0 flex flex-col items-center px-4 py-4 sm:py-6 gap-3 sm:gap-4 relative">
        ...
        <div className="relative w-full max-w-2xl xl:max-w-3xl mx-auto flex flex-col gap-2 sm:gap-3">
          <div className="flex items-end justify-between gap-2">
            <div className="min-w-0">
              <p className="text-xs font-black uppercase tracking-[0.3em] text-indigo-600 dark:text-indigo-400">Discover</p>
              <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-slate-50 mt-1 leading-tight">
            ...
            <div className="flex items-center gap-2 flex-none">
              <button
                ...
                className="lg:hidden inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 shadow-sm text-xs font-black text-slate-700 dark:text-slate-200 hover:border-indigo-200 dark:border-indigo-500/30 hover:text-indigo-700 dark:text-indigo-300 transition-colors"
              >
                <SlidersHorizontal className="w-3.5 h-3.5" />
                <span>Filters</span>
                {activeFilterCount > 0 && (
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 shadow-sm text-xs font-black text-slate-700 dark:text-slate-200 hover:border-indigo-200 dark:border-indigo-500/30 hover:text-indigo-700 dark:text-indigo-300 transition-colors"
              >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 rounded-2xl bg-white dark:bg-white/[0.03] border-2 border-slate-200 dark:border-white/10 text-sm font-semibold text-slate-900 dark:text-slate-50 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-600 shadow-sm transition-colors"
            />
          </div>

          <div className="hidden lg:flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-500 font-semibold px-1">
            ...
            {filters.q.trim() && (
              <button
                ...
                className="flex items-center gap-1 text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:text-indigo-300 font-bold transition-colors"
              >
                <X className="w-3 h-3" />
                Clear search
              </button>
        ...
        <div className="relative w-full max-w-2xl xl:max-w-3xl flex-1 min-h-0 flex items-center justify-center">
            ...
            {swipeFeedback && (
              <motion.div
                ...
                className={`absolute top-2 right-2 z-40 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-black shadow-lg backdrop-blur-sm ${
                  swipeFeedback === 'saved'
                    ? 'border-emerald-200 dark:border-emerald-500/30 bg-emerald-50 text-emerald-800 dark:text-emerald-300 shadow-emerald-100'
                    : 'border-slate-200 dark:border-white/10 bg-white dark:bg-white/[0.03] text-slate-700 dark:text-slate-200 shadow-slate-200'
                }`}
              >
                <Bookmark className={`w-4 h-4 ${swipeFeedback === 'saved' ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-500 dark:text-slate-500'}`} />
          ...
          <div className="relative w-full h-full">
            {loading && jobs.length === 0 ? (
              <div className="w-full h-full rounded-[2.5rem] bg-white/95 dark:bg-[#0A0C12]/90 backdrop-blur border border-slate-200 dark:border-white/10 p-8 flex flex-col items-center justify-center text-center shadow-[0_20px_80px_rgba(15,23,42,0.08)]">
                <SlidersHorizontal className="w-8 h-8 text-indigo-600 dark:text-indigo-400 animate-pulse mb-4" />
                <h3 className="text-xl font-black text-slate-900 dark:text-slate-50 mb-2">Finding matching roles…</h3>
              ...
              <div className="w-full h-full rounded-[2.5rem] bg-white/95 dark:bg-[#0A0C12]/90 backdrop-blur border border-slate-200 dark:border-white/10 p-8 flex flex-col items-center justify-center text-center shadow-[0_20px_80px_rgba(15,23,42,0.08)]">
                <div className="w-16 h-16 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 dark:text-indigo-400 mb-4">
                  <Search className="w-8 h-8" />
                </div>
                <h3 className="text-xl font-black text-slate-900 dark:text-slate-50 mb-2">No roles match your current filters</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300 font-medium max-w-md mb-6">
                  {activeFilterCount > 0
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <motion.div
                      ...
                      className="absolute top-6 left-6 z-30 pointer-events-none inline-flex items-center gap-2 rounded-full border border-emerald-200 dark:border-emerald-500/30 bg-emerald-50 px-4 py-2 text-xs font-black text-emerald-800 dark:text-emerald-300 shadow-[0_10px_30px_rgba(16,185,129,0.18)]"
                    >
                    ...
                    <motion.div
                      ...
                      className="absolute top-6 right-6 z-30 pointer-events-none inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-white/10 bg-white dark:bg-white/[0.03] px-4 py-2 text-xs font-black text-slate-700 dark:text-slate-200 shadow-[0_10px_30px_rgba(15,23,42,0.12)]"
                    >
              ...
              <div className="w-full h-full rounded-[2.5rem] bg-white/95 dark:bg-[#0A0C12]/90 backdrop-blur border border-slate-200 dark:border-white/10 p-8 flex flex-col items-center justify-center text-center shadow-[0_20px_80px_rgba(15,23,42,0.08)]">
                ...
                <h3 className="text-xl font-black text-slate-900 dark:text-slate-50 mb-2">
        ...
        {currentJob && (
          <div className="relative w-full max-w-2xl xl:max-w-3xl mx-auto flex flex-col gap-2">
            <div className="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-500 px-1">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <button
                ...
                className="h-12 sm:h-14 rounded-2xl bg-white dark:bg-white/[0.03] border-2 border-slate-200 dark:border-white/10 text-slate-900 dark:text-slate-50 flex items-center justify-center gap-2 font-black text-xs transition-all shadow-sm hover:border-rose-200 hover:text-rose-600"
              >
              ...
              <a
                ...
                className={`h-12 sm:h-14 rounded-2xl border-2 flex items-center justify-center gap-2 font-black text-xs transition-all shadow-sm ${
                  currentJob.applyUrl
                    ? 'bg-white dark:bg-white/[0.03] border-slate-200 dark:border-white/10 text-slate-900 dark:text-slate-50 hover:border-indigo-200 dark:border-indigo-500/30 hover:text-indigo-700 dark:text-indigo-300'
                    : 'bg-slate-100 dark:bg-white/[0.05] border-slate-200 dark:border-white/10 text-slate-400 dark:text-slate-600 cursor-not-allowed'
                }`}
              >
        ...
        <div className="relative text-xs font-semibold text-slate-500 dark:text-slate-500 mt-1 text-center max-w-2xl leading-relaxed hidden md:block">
